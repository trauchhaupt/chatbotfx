...
public class SettingsJson extends AbstractJson {
    ...
    private int messagesToStripForLlm;
    ...
    public SettingsJson setMessagesToStripForLlm(int messagesToStripForLlm) {
        this.messagesToStripForLlm = messagesToStripForLlm;
        return this;
    }
}
