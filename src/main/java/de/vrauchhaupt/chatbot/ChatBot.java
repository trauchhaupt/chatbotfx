...
import de.vrauchhaupt.chatbot.manager.SettingsManager;
import de.vrauchhaupt.chatbot.manager.ThreadManager;
...
public class ChatBot extends Application {
    ...
    private void addImageToPrimaryStage(Stage primaryStage, String filename) {
        try (InputStream fileStream = getClass().getResourceAsStream("/de/vonrauchhaupt/chatbot/" + filename)) {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        URL resource = getClass().getResource("/de/vrauchhaupt/chatbot/view/ChatMainWindow.fxml");
